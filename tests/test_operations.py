...
class TestOperationFactory:
    ...
    def test_operation_factory_aliases(self):
    # Ensure aliases map correctly to same classes
        assert type(OperationFactory.create_operation('+')) is OperationFactory._operations['add']
        assert type(OperationFactory.create_operation('-')) is OperationFactory._operations['subtract']
        assert type(OperationFactory.create_operation('*')) is OperationFactory._operations['multiply']
        assert type(OperationFactory.create_operation('/')) is OperationFactory._operations['divide']
        assert type(OperationFactory.create_operation('^')) is OperationFactory._operations['power']